  ...
  (function (e) {
    ...
    if (void 0 !== e.fn.animsition) {
      ...
      t.animsition({
        ...
        outDuration: 500,
        linkElement:
          'a:not([target="_blank"]):not([href^="#"]):not([rel="nofollow"]):not([href~="#"]):not([href^=mailto]):not([href^=tel]):not(.sf-with-ul):not(.js-offcanvas-menu-open):not(.js-offcanvas-menu-close):not(.vlt-offcanvas-menu__navigation a):not(.vlt-navbar-logo)',
